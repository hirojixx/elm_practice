(function (scope) {
  ...
  function _Debug_regionToString(region) {
    if (region.S.F === region.ad.F) {
      return 'on line ' + region.S.F;
    }
    return 'on lines ' + region.S.F + ' through ' + region.ad.F;
  }
  ...
  */
  ...
  function _Browser_visibilityInfo() {
    return (typeof _VirtualDom_doc.hidden !== 'undefined')
      ? { bd: 'hidden', a4: 'visibilitychange' }
      :
      (typeof _VirtualDom_doc.mozHidden !== 'undefined')
        ? { bd: 'mozHidden', a4: 'mozvisibilitychange' }
        :
        (typeof _VirtualDom_doc.msHidden !== 'undefined')
          ? { bd: 'msHidden', a4: 'msvisibilitychange' }
          :
          (typeof _VirtualDom_doc.webkitHidden !== 'undefined')
            ? { bd: 'webkitHidden', a4: 'webkitvisibilitychange' }
            : { bd: 'hidden', a4: 'visibilitychange' };
  }
  ...
  var $elm$url$Url$Url = F6(
    function (protocol, host, port_, path, query, fragment) {
      return { ak: fragment, an: host, aw: path, ay: port_, aC: protocol, aE: query };
    });
  ...
  var $author$project$NotFound$page = {
    a1: _List_fromArray(
      [
        A2(
          $elm$html$Html$div,
  ...
  var $author$project$NotFound$main = $elm$browser$Browser$document(
    {
      ...
      bG: function (_v4) {
        return $author$project$NotFound$page;
      }
    });
  var $elm$json$Json$Decode$decodeValue = _Json_run;
  var $author$project$Index$Flags = F7(
    function (root, pwd, dirs, files, readme, project, exactDeps) {
      return { M: dirs, af: exactDeps, ai: files, aB: project, aD: pwd, aF: readme, aL: root };
    });
  ...
  var $elm$project_metadata_utils$Elm$Project$ApplicationInfo = F6(
    function (elm, dirs, depsDirect, depsIndirect, testDepsDirect, testDepsIndirect) {
      return { a9: depsDirect, ac: depsIndirect, M: dirs, v: elm, bB: testDepsDirect, aU: testDepsIndirect };
    });
  ...
  var $elm$project_metadata_utils$Elm$Project$PackageInfo = F8(
    function (name, summary, license, version, exposed, deps, testDeps, elm) {
      return { a8: deps, v: elm, ah: exposed, bh: license, au: name, aS: summary, bA: testDeps, bF: version };
    });
  ...
  var $author$project$Index$File = F2(
    function (name, runnable) {
      return { au: name, br: runnable };
    });
  var $elm$json$Json$Decode$bool = _Json_decodeBool;
  var $author$project$Index$fileDecoder = A3(
    $elm$json$Json$Decode$map2,
    $author$project$Index$File,
    A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
    A2($elm$json$Json$Decode$field, 'runnable', $elm$json$Json$Decode$bool));
  ...
  var $author$project$Index$decoder = A8(
    $elm$json$Json$Decode$map7,
    $author$project$Index$Flags,
    ...
    A2(
      $elm$json$Json$Decode$field,
      'files',
      $elm$json$Json$Decode$list($author$project$Index$fileDecoder)),
    A2(
      $elm$json$Json$Decode$field,
      'readme',
    ...
    A2(
      $elm$json$Json$Decode$field,
      'outline',
      $elm$json$Json$Decode$nullable($elm$project_metadata_utils$Elm$Project$decoder)),
    A2(
      $elm$json$Json$Decode$field,
      'exactDeps',
      $elm$json$Json$Decode$dict($elm$project_metadata_utils$Elm$Version$decoder)));
  var $elm$json$Json$Decode$value = _Json_decodeValue;
  var $elm$html$Html$header = _VirtualDom_node('header');
  var $elm$html$Html$a = _VirtualDom_node('a');
  var $elm$html$Html$span = _VirtualDom_node('span');
  var $author$project$Index$Navigator$slash = A2(
    $elm$html$Html$span,
    _List_fromArray(
      [
  ...
  var $author$project$Index$Navigator$addSlash = F2(
    function (front, back) {
      return A2(
        $elm$core$List$cons,
        front,
        A2($elm$core$List$cons, $author$project$Index$Navigator$slash, back));
    });
  ...
  var $author$project$Index$Icon$icon = F3(
    function (color, size, pathString) {
      return A2(
        $elm$svg$Svg$svg,
        _List_fromArray(
          [
            ...
            $elm$svg$Svg$Attributes$viewBox('0 0 1792 1792')
          ]),
        _List_fromArray(
          [
            A2(
  ...
  var $author$project$Index$Navigator$makeLinks = F4(
    function (root, dirs, oldPath, revAnchors) {
      makeLinks:
      while (true) {
        if (dirs.b) {
          var dir = dirs.a;
          var otherDirs = dirs.b;
          var newPath = oldPath + ('/' + dir);
          var anchor = A2(
            $elm$html$Html$a,
            _List_fromArray(
              [
                $elm$html$Html$Attributes$href(newPath)
              ]),
            _List_fromArray(
              [
          ...
          var $temp$root = root,
            $temp$dirs = otherDirs,
            $temp$oldPath = newPath,
            $temp$revAnchors = A2($elm$core$List$cons, anchor, revAnchors);
          root = $temp$root;
          dirs = $temp$dirs;
          oldPath = $temp$oldPath;
          revAnchors = $temp$revAnchors;
          continue makeLinks;
        } else {
          var home = A2(
            $elm$html$Html$a,
            _List_fromArray(
              [
                ...
                $elm$html$Html$Attributes$title(root),
                A2($elm$html$Html$Attributes$style, 'display', 'inherit')
              ]),
            _List_fromArray(
              [$author$project$Index$Icon$home]));
          if (!revAnchors.b) {
            return _List_fromArray(
              [home]);
          } else {
            var lastAnchor = revAnchors.a;
            var otherRevAnchors = revAnchors.b;
            return A2(
              $elm$core$List$cons,
              home,
              A2(
                $elm$core$List$cons,
                $author$project$Index$Navigator$slash,
                A3(
                  $elm$core$List$foldl,
                  $author$project$Index$Navigator$addSlash,
                  _List_fromArray(
                    [lastAnchor]),
                  otherRevAnchors)));
          }
  ...
  var $author$project$Index$Navigator$view = F2(
    function (root, dirs) {
      return A2(
        $elm$html$Html$div,
        _List_fromArray(
        ...
        A4($author$project$Index$Navigator$makeLinks, root, dirs, '', _List_Nil));
    });
  ...
  var $author$project$Index$Skeleton$boxFooter = function (maybeFooter) {
    if (maybeFooter.$ === 1) {
      return $elm$html$Html$text('');
    } else {
      var _v1 = maybeFooter.a;
      var path = _v1.a;
        ...
        _List_fromArray(
          [
            A2(
              ...
              _List_fromArray(
                [
                  $elm$html$Html$Attributes$class('box-footer')
                ]),
              _List_fromArray(
  ...
  var $author$project$Index$Skeleton$boxHelp = F3(
    function (boxTitle, items, footer) {
      return A2(
        $elm$html$Html$div,
        _List_fromArray(
          [
        ...
        A2(
          ...
          A2(
            ...
            _List_fromArray(
              [
                $elm$html$Html$text(boxTitle)
              ])),
          _Utils_ap(
            items,
            _List_fromArray(
              [
                $author$project$Index$Skeleton$boxFooter(footer)
              ]))));
    });
  var $author$project$Index$Skeleton$box = function (_v0) {
    var title = _v0.U;
    var items = _v0.E;
    var footer = _v0.D;
    var realItems = A2(
      ...
      items);
    return A3($author$project$Index$Skeleton$boxHelp, title, realItems, footer);
  };
  ...
  var $author$project$Index$viewDir = function (dir) {
    return (A2($elm$core$String$startsWith, '.', dir) || (dir === 'elm-stuff')) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
      _List_fromArray(
        [
          A2(
            $elm$html$Html$a,
            _List_fromArray(
              [
                $elm$html$Html$Attributes$href(dir)
              ]),
            _List_fromArray(
              [
                $author$project$Index$Icon$folder,
                $elm$html$Html$text(dir)
              ]))
        ]));
  };
  ...
  var $author$project$Index$Icon$extensionIcons = $elm$core$Dict$fromList(
    _List_fromArray(
      [
        _Utils_Tuple2('jpg', $author$project$Index$Icon$image),
        _Utils_Tuple2('jpeg', $author$project$Index$Icon$image),
        _Utils_Tuple2('png', $author$project$Index$Icon$image),
        _Utils_Tuple2('gif', $author$project$Index$Icon$image)
      ]));
  ...
  var $author$project$Index$Icon$getExtensionHelp = function (segments) {
    getExtensionHelp:
    while (true) {
      if (!segments.b) {
        return '';
        ...
        if (!segments.b.b) {
          var ext = segments.a;
          return $elm$core$String$toLower(ext);
        } else {
          var rest = segments.b;
          var $temp$segments = rest;
          segments = $temp$segments;
          continue getExtensionHelp;
        }
      }
    }
  };
  var $author$project$Index$Icon$getExtension = function (str) {
    return $author$project$Index$Icon$getExtensionHelp(
  ...
  var $author$project$Index$Icon$lookup = function (fileName) {
    var extension = $author$project$Index$Icon$getExtension(fileName);
    return A2(
      $elm$core$Maybe$withDefault,
      $author$project$Index$Icon$file,
      A2($elm$core$Dict$get, extension, $author$project$Index$Icon$extensionIcons));
  };
  var $author$project$Index$viewFile = function (_v0) {
    var name = _v0.au;
    return A2($elm$core$String$startsWith, '.', name) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
      _List_fromArray(
        [
          A2(
            $elm$html$Html$a,
            ...
            _List_fromArray(
              [
                $author$project$Index$Icon$lookup(name),
                $elm$html$Html$text(name)
              ]))
        ]));
  };
  var $author$project$Index$viewFiles = F2(
    function (dirs, files) {
      return $author$project$Index$Skeleton$box(
        {
          D: $elm$core$Maybe$Nothing,
          E: _Utils_ap(
            A2(
              $elm$core$List$filterMap,
              $author$project$Index$viewDir,
              $elm$core$List$sort(dirs)),
            A2(
              $elm$core$List$filterMap,
              $author$project$Index$viewFile,
              A2(
  ...
  var $author$project$Index$Skeleton$readmeBox = function (markdown) {
    var readme = A2(
      ...
      markdown);
    return A3(
      $author$project$Index$Skeleton$boxHelp,
      'README',
      _List_fromArray(
        [readme]),
      $elm$core$Maybe$Nothing);
  };
  var $author$project$Index$viewReadme = function (readme) {
    if (readme.$ === 1) {
      return $elm$html$Html$text('');
    } else {
      var markdown = readme.a;
      return $author$project$Index$Skeleton$readmeBox(markdown);
    }
  };
  var $author$project$Index$viewLeftColumn = F3(
    function (dirs, files, readme) {
      return A2(
        ...
        _List_fromArray(
          [
            A2($author$project$Index$viewFiles, dirs, files),
            $author$project$Index$viewReadme(readme)
          ]));
    });
  ...
  var $author$project$Index$toPackageUrl = F2(
    function (name, version) {
      return 'https://package.elm-lang.org/packages/' + ($elm$project_metadata_utils$Elm$Package$toString(name) + ('/' + $elm$project_metadata_utils$Elm$Version$toString(version)));
    });
  var $author$project$Index$viewVersion = function (_v0) {
    var pkg = _v0.a;
    var version = _v0.b;
    return _List_fromArray(
      [
        A2(
          ...
          _List_fromArray(
            [
              $author$project$Index$Icon$package,
              A2(
                $elm$html$Html$a,
                _List_fromArray(
                  [
                    $elm$html$Html$Attributes$href(
                      A2($author$project$Index$toPackageUrl, pkg, version))
                  ]),
                _List_fromArray(
                  [
                    $elm$html$Html$text(
  ...
  var $author$project$Index$viewConstraint = F2(
    function (exactDeps, _v0) {
      var pkg = _v0.a;
      var _v1 = A2(
        $elm$core$Dict$get,
        $elm$project_metadata_utils$Elm$Package$toString(pkg),
      ...
      if (!_v1.$) {
        var vsn = _v1.a;
        return $author$project$Index$viewVersion(
  ...
  var $author$project$Index$viewDeps = F2(
    function (exactDeps, project) {
      var dependencies = function () {
        if (!project.$) {
          var info = project.a;
          return A2($elm$core$List$map, $author$project$Index$viewVersion, info.a9);
        } else {
          var info = project.a;
          return A2(
            $elm$core$List$map,
            $author$project$Index$viewConstraint(exactDeps),
            info.a8);
        }
      }();
      return $author$project$Index$Skeleton$box(
        { D: $elm$core$Maybe$Nothing, E: dependencies, U: 'Dependencies' });
    });
  var $elm$project_metadata_utils$Elm$License$toString = function (_v0) {
    var spdx = _v0.a;
    return spdx;
  };
  var $author$project$Index$viewProjectSummary = function (project) {
    if (!project.$) {
      var info = project.a;
      return $author$project$Index$Skeleton$box(
        {
          ...
          E: _List_fromArray(
            [
              _List_fromArray(
                [
                  $elm$html$Html$text(
                    'Name: ' + $elm$project_metadata_utils$Elm$Package$toString(info.au))
                ]),
              _List_fromArray(
                [
                  $elm$html$Html$text(
                    'Version: ' + $elm$project_metadata_utils$Elm$Version$toString(info.bF))
                ]),
              _List_fromArray(
                [
                  $elm$html$Html$text(
                    'License: ' + $elm$project_metadata_utils$Elm$License$toString(info.bh))
                ])
            ]),
          U: 'Package Info'
        });
  ...
  var $author$project$Index$viewTestDeps = F2(
    function (exactDeps, project) {
      var dependencies = function () {
        if (!project.$) {
          var info = project.a;
          return A2($elm$core$List$map, $author$project$Index$viewVersion, info.bB);
        } else {
          var info = project.a;
          return A2(
            $elm$core$List$map,
      ...
      return $author$project$Index$Skeleton$box(
        { D: $elm$core$Maybe$Nothing, E: dependencies, U: 'Test Dependencies' });
    });
  var $author$project$Index$viewRightColumn = F2(
    function (exactDeps, maybeProject) {
      return A2(
        $elm$html$Html$section,
        _List_fromArray(
          [
        ...
        function () {
          if (maybeProject.$ === 1) {
            ...
            return _List_fromArray(
              [
                $author$project$Index$viewProjectSummary(project),
                A2($author$project$Index$viewDeps, exactDeps, project),
                A2($author$project$Index$viewTestDeps, exactDeps, project)
              ]);
          }
        }());
    });
  var $author$project$Index$view = function (model) {
    if (model.$ === 1) {
      ...
      var pwd = model.a.aD;
      var dirs = model.a.M;
      var files = model.a.ai;
      var readme = model.a.aF;
      var project = model.a.aB;
      var exactDeps = model.a.af;
      return {
        a1: _List_fromArray(
          [
            A2(
            ...
            A2(
              ...
              _List_fromArray(
                [
                  A2($author$project$Index$Navigator$view, root, pwd),
                  A3($author$project$Index$viewLeftColumn, dirs, files, readme),
                  A2($author$project$Index$viewRightColumn, exactDeps, project),
                  A2(
                    $elm$html$Html$div,
                    _List_fromArray(
                      [
        ...
        U: A2(
          $elm$core$String$join,
          '/',
          A2($elm$core$List$cons, '~', pwd))
      };
    }
  };
  var $author$project$Index$main = $elm$browser$Browser$document(
    {
      bf: function (flags) {
        return _Utils_Tuple2(
          A2($elm$json$Json$Decode$decodeValue, $author$project$Index$decoder, flags),
  ...
  var $author$project$Errors$fill = F2(
    function (left, right) {
      return _Utils_ap(
        left,
        _Utils_ap(
  ...
  var $author$project$Errors$viewHeader = F2(
    function (title, maybeFilePath) {
      ...
      return A2(
        ...
        _List_fromArray(
          [
            $elm$html$Html$text(
              A2($author$project$Errors$fill, left, right) + '\n\n')
          ]));
    });
  var $author$project$Errors$addBold = F2(
    function (bool, attrs) {
      return bool ? A2(
        $elm$core$List$cons,
  ...
  var $author$project$Errors$colorToCss = function (color) {
    switch (color) {
      case 0:
  ...
  var $author$project$Errors$addColor = F2(
      ...
      if (maybeColor.$ === 1) {
        ...
        return A2(
          ...
          A2(
            ...
            'color',
            $author$project$Errors$colorToCss(color)),
          attrs);
      }
    });
  var $author$project$Errors$addUnderline = F2(
    function (bool, attrs) {
      return bool ? A2(
        $elm$core$List$cons,
  ...
  var $author$project$Errors$styleToAttrs = function (_v0) {
    var bold = _v0.a2;
    var underline = _v0.bD;
    var color = _v0.a5;
    return A2(
      $author$project$Errors$addBold,
      bold,
      A2(
        $author$project$Errors$addUnderline,
        underline,
        A2($author$project$Errors$addColor, color, _List_Nil)));
  };
  var $author$project$Errors$viewMessage = function (chunks) {
    if (!chunks.b) {
      return _List_fromArray(
        [
          $elm$html$Html$text('\n\n\n')
      ...
      var htmlChunk = function () {
        if (!chunk.$) {
          ...
          return A2(
            $elm$html$Html$span,
            $author$project$Errors$styleToAttrs(style),
            _List_fromArray(
              [
      ...
      return A2(
        $elm$core$List$cons,
        htmlChunk,
        $author$project$Errors$viewMessage(others));
    }
  };
  var $author$project$Errors$viewProblem = F2(
    function (filePath, problem) {
      return A2(
        ...
        A2(
          $elm$core$List$cons,
          A2(
            $author$project$Errors$viewHeader,
            problem.U,
            $elm$core$Maybe$Just(filePath)),
          $author$project$Errors$viewMessage(problem.as)));
    });
  var $author$project$Errors$viewBadModule = function (_v0) {
    var path = _v0.aw;
    var problems = _v0.bn;
    return A2(
      $elm$html$Html$span,
      ...
      A2(
        $elm$core$List$map,
        $author$project$Errors$viewProblem(path),
        problems));
  };
  ...
  var $author$project$Errors$viewSeparator = F2(
  ...
  var $author$project$Errors$viewBadModules = function (badModules) {
    if (!badModules.b) {
      return _List_Nil;
    } else {
      if (!badModules.b.b) {
        ...
        return _List_fromArray(
          [
            $author$project$Errors$viewBadModule(badModule)
          ]);
      } else {
        var a = badModules.a;
        var _v1 = badModules.b;
        var b = _v1.a;
        var cs = _v1.b;
        return A2(
          $elm$core$List$cons,
          $author$project$Errors$viewBadModule(a),
          A2(
            $elm$core$List$cons,
            A2($author$project$Errors$viewSeparator, a.au, b.au),
            $author$project$Errors$viewBadModules(
              A2($elm$core$List$cons, b, cs))));
      }
    }
  };
  var $author$project$Errors$viewErrorHelp = function (error) {
    if (!error.$) {
      var path = error.a.aw;
      var title = error.a.U;
      var message = error.a.as;
      return A2(
        $elm$core$List$cons,
        A2($author$project$Errors$viewHeader, title, path),
        $author$project$Errors$viewMessage(message));
    } else {
      var badModules = error.a;
      return $author$project$Errors$viewBadModules(badModules);
    }
  };
  var $author$project$Errors$viewError = function (error) {
    return A2(
      $elm$html$Html$div,
      _List_fromArray(
        [
          ...
          A2($elm$html$Html$Attributes$style, 'align-items', 'center'),
          A2($elm$html$Html$Attributes$style, 'background-color', 'rgb(39, 40, 34)'),
          A2($elm$html$Html$Attributes$style, 'color', 'rgb(233, 235, 235)'),
      ...
      _List_fromArray(
        [
          A2(
            ...
            $author$project$Errors$viewErrorHelp(error))
        ]));
  };
  var $author$project$Errors$view = function (result) {
    return {
      a1: function () {
        if (result.$ === 1) {
          var err = result.a;
          ...
          return _List_fromArray(
            [
              $author$project$Errors$viewError(error)
            ]);
        }
      }(),
      U: 'Problem!'
  ...
  var $author$project$Errors$main = $elm$browser$Browser$document(
    {
      bf: function (flags) {
        return _Utils_Tuple2(
      ...
      bG: $author$project$Errors$view
    });
  _Platform_export({
    'Errors': { 'init': $author$project$Errors$main($elm$json$Json$Decode$value)(0) }, 'NotFound': {
      'init': $author$project$NotFound$main(
        $elm$json$Json$Decode$succeed(0))(0)
    }, 'Index': { 'init': $author$project$Index$main($elm$json$Json$Decode$value)(0) }
  });
}(this));